...
export const getThesesFiltered = (params = {}) => {
  ...
  if (typeof params.author_name === 'string' && params.author_name.trim() !== '') q.set('author_name', params.author_name.trim());
...
export const citeThesis = (thesisId) => postJson(`/theses/${thesisId}/cite`, {});
